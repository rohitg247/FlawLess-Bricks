...
import { postContact } from '../utils/fetchApi';
...
export default function ContactForm() {
    const { hasCopied, onCopy } = useClipboard('rohitg247@gmail.com');

    const [data, setData] = useState({ name: "", email: "", phone: "", purpose: "", city: "", message: "" })
                    ...
                    <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
                        ...
                        <Stack
                            ...
                            <Stack
                                ...
                                <Link href="https://wa.me/+917666576956">
                                    <IconButton
                                        aria-label="whatsapp"
                                        variant="ghost"
                                        size="lg"
                            ...
                            <Box
                                ...
                                <VStack spacing={5}>
                                    ...
                                    <FormControl isRequired>
                                        ...
                                        <InputGroup>
                                            <InputLeftElement children={<BsPerson />} />
                                            <Input type="text" name="phone" onChange={handleChange} placeholder="Your Contact Number" />
                                        </InputGroup>
                                    </FormControl>
                                    ...
                                    <FormControl as='fieldset'>
                                        ...
                                        <FormHelperText>Select your requirement</FormHelperText>
                                    </FormControl>
